...
public class  TankHandler : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // hit1 = Physics2D.Raycast(transform.position + new Vector3(rayOffset, 0, 0) * direction, Vector2.down, raycastDistance, LayerMask.GetMask("Map"));
        // hit3 = Physics2D.Raycast(transform.position - new Vector3(rayOffset, 0, 0) * direction, Vector2.down, raycastDistance, LayerMask.GetMask("Map"));
        
        // Debug.DrawRay(transform.position + new Vector3(rayOffset, 0, 0) * direction, Vector2.down * 2f, Color.red);
        // Debug.DrawRay(transform.position - new Vector3(rayOffset, 0, 0) * direction, Vector2.down * 2f, Color.blue);
    ...
    Vector2 normVec;
    Vector3 frontVec;
    public void SetAngleToRay(int direction) {
        ...
        // Debug.DrawRay(transform.position, slopeHit.normal * 2f, Color.blue);
        // if (slopeHit) {
